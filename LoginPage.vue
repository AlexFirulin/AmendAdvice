<template>
  <div class="bg-black screen">
  <div class="create">
    <span class="amend-acc">Your amend account</span>
  </div>
  <div>
    <span class="loggin">Login with your phone number</span>
  </div>
...
<div class="flex">
    ...
    <div class="phone">
      <label for="numbers" class=" sr-only">Choose a state</label>
    <input id="tel" type="number" class="bg-gray-50 border border-gray-300 text-gray-900 rounded-r-lg border-l-gray-100 dark:border-l-gray-700 border-l-2 focus:ring-blue-500 focus:border-blue-500 flex p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
    </div>

</div>

  <div class="bg-black text-white msg-send">
    We will send verification code to this number
  </div>
  <div class="cont">
    <button class="btn-cont">Continue</button>
  </div>
  <div class="bg-black text-white flex acces links">
    <a href=""><p>Changed phone number?</p></a>
    <a href=""><p>Restore access</p></a>
  </div>
</div>
<router-view />
</template>
